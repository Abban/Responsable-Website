<?php include_once('header.php'); ?>
	...
	<div id="content">
		...
		<section id="typography">
			...
			<p>Responsable doesnt have a reset. Instead we decided to merge a typographic baseline with Nicholas Gallagher's <a href="http://nicolasgallagher.com/about-normalize-css/">Normalize Css</a>. We also added some base styling for forms and tables. You can find those at the bottom of the normalize baseline stylesheet for editing. Check out some style samples below.</p>
